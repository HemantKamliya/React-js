...
function Card({username,channel=56}) {
  return (

    <div class="w-[300px] rounded-md border my-5">
      <img
      ...
      />
      <div class="p-4">
        <h1 class="text-lg font-semibold">About {username}</h1>
        <p class="mt-3 text-sm text-gray-600">
          Lorem ipsum {channel} sit amet consectetur adipisicing elit. Excepturi,
          debitis?
        </p>
        <button
          type="button"
